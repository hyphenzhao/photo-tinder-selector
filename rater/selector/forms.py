...
class AppConfigForm(forms.ModelForm):
    class Meta:
        model = AppConfig
        fields = ["source_folder", "output_folder", "original_folder", "final_folder", "video_folder"]
        widgets = {
            ...
            "video_folder": forms.TextInput(attrs={"class": "form-control", "placeholder": r"e.g. D:\\Photos\\GameVideos"}),
        }
